...
#define __KERNEL_HEADERS__ "/mnt/ExtData/cross/buildroot/output/build/linux-headers-3.4.110/usr/include"
...
#undef __UCLIBC_HAS_FALLOCATE__
#undef __UCLIBC_HAS_EXECVPE__
#undef __UCLIBC_HAS_MKOSTEMP__
#undef __UCLIBC_HAS_ADVANCED_REALTIME__

/* Realtime functions */
#define __UCLIBC_HAS_RT_SCHED__ 1
#define __UCLIBC_HAS_RT_MLOCK__ 1
#undef __UCLIBC_HAS_RT_FALLOCATE__
#define __UCLIBC_HAS_RT_MADVISE__ 1
#define __UCLIBC_HAS_RT_MQUEUE__ 1
#define __UCLIBC_HAS_RT_CLOCK__ 1
#define __UCLIBC_HAS_RT_FADVISE__ 1
#define __UCLIBC_HAS_RT_SEMA__ 1
#define __UCLIBC_HAS_RT_MMAN__ 1
#define __UCLIBC_HAS_RT_SIG__ 1
#define __UCLIBC_HAS_RT_FDATASYNC__ 1
#define __UCLIBC_HAS_FADVISE__ 1
#define __UCLIBC_HAS_MEMALIGN__ 1
...
#define __UCLIBC_HAS_RPC_CLIENT__ 1
#define __UCLIBC_HAS_SVC_EXTENSIONS__ 1
#define __UCLIBC_HAS_XDR_EXTENSIONS__ 1
...
#define __CROSS_COMPILER_PREFIX__ "/mnt/ExtData/cross/buildroot-2015.11/output/host/usr/bin/arm-buildroot-linux-uclibcgnueabi-"
